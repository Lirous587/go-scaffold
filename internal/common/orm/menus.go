...
var MenuWhere = struct {
	...
	Title:       whereHelperstring{field: "\"menus\".\"title\""},
	Description: whereHelpernull_String{field: "\"menus\".\"description\""},
	ParentID:    whereHelperint{field: "\"menus\".\"parent_id\""},
}
...
type menuR struct {
	Parent      *Menu     `boil:"Parent" json:"Parent" toml:"Parent" yaml:"Parent"`
	ParentMenus MenuSlice `boil:"ParentMenus" json:"ParentMenus" toml:"ParentMenus" yaml:"ParentMenus"`
...
func (o *Menu) GetParentMenus() MenuSlice {
	if o == nil {
		return nil
	}

	return o.R.GetParentMenus()
}

func (r *menuR) GetParentMenus() MenuSlice {
	if r == nil {
		return nil
	}

	return r.ParentMenus
}

func (o *Menu) GetRoles() RoleSlice {
	if o == nil {
		return nil
	}
...
func (r *menuR) GetRoles() RoleSlice {
	if r == nil {
		return nil
	}
...
var (
	menuAllColumns            = []string{"id", "created_at", "title", "description", "parent_id"}
	menuColumnsWithoutDefault = []string{"title", "parent_id"}
	menuColumnsWithDefault    = []string{"id", "created_at", "description"}
...
func (o *Menu) Parent(mods ...qm.QueryMod) menuQuery {
...
// ParentMenus retrieves all the menu's Menus with an executor via parent_id column.
func (o *Menu) ParentMenus(mods ...qm.QueryMod) menuQuery {
...
func (o *Menu) Roles(mods ...qm.QueryMod) roleQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"roles_menus\" on \"roles\".\"id\" = \"roles_menus\".\"role_id\""),
		qm.Where("\"roles_menus\".\"menu_id\"=?", o.ID),
	)
...
func (menuL) LoadParent(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMenu interface{}, mods queries.Applicator) error {
	var slice []*Menu
	var object *Menu
	...
	if singular {
		...
		foreign.R.ParentMenus = append(foreign.R.ParentMenus, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ParentID == foreign.ID {
				...
				foreign.R.ParentMenus = append(foreign.R.ParentMenus, local)
				break
			}
		}
	}
...
// LoadParentMenus allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (menuL) LoadParentMenus(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMenu interface{}, mods queries.Applicator) error {
	var slice []*Menu
	var object *Menu
	...
	query := NewQuery(
		qm.From(`menus`),
		qm.WhereIn(`menus.parent_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.ParentMenus = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &menuR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ParentID {
				local.R.ParentMenus = append(local.R.ParentMenus, foreign)
				if foreign.R == nil {
					foreign.R = &menuR{}
				}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (menuL) LoadRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMenu interface{}, mods queries.Applicator) error {
	var slice []*Menu
	var object *Menu
	...
	query := NewQuery(
		qm.Select("\"roles\".\"id\", \"roles\".\"created_at\", \"roles\".\"name\", \"roles\".\"description\", \"a\".\"menu_id\""),
		qm.From("\"roles\""),
		qm.InnerJoin("\"roles_menus\" as \"a\" on \"roles\".\"id\" = \"a\".\"role_id\""),
		qm.WhereIn("\"a\".\"menu_id\" in ?", argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetParent of the menu to the related item.
// Sets o.R.Parent to related.
// Adds o to related.R.ParentMenus.
func (o *Menu) SetParent(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Menu) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &menuR{
			ParentMenus: MenuSlice{o},
		}
	} else {
		related.R.ParentMenus = append(related.R.ParentMenus, o)
	}

	return nil
}

// AddParentMenus adds the given related objects to the existing relationships
// of the menu, optionally inserting them as new records.
// Appends related to o.R.ParentMenus.
// Sets related.R.Parent appropriately.
func (o *Menu) AddParentMenus(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Menu) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.ParentMenus = append(o.R.ParentMenus, related...)
	}
...
func (o *Menu) AddRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Role) error {
	var err error
	for _, rel := range related {
		if insert {
			if err = rel.Insert(ctx, exec, boil.Infer()); err != nil {
	...
	for _, rel := range related {
		query := "insert into \"roles_menus\" (\"menu_id\", \"role_id\") values ($1, $2)"
		values := []interface{}{o.ID, rel.ID}
...
// Sets o.R.Menus's Roles accordingly.
// Replaces o.R.Roles with related.
// Sets related.R.Menus's Roles accordingly.
func (o *Menu) SetRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Role) error {
	query := "delete from \"roles_menus\" where \"menu_id\" = $1"
	...
	removeRolesFromMenusSlice(o, related)
	if o.R != nil {
		o.R.Roles = nil
	}
...
func (o *Menu) RemoveRoles(ctx context.Context, exec boil.ContextExecutor, related ...*Role) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"roles_menus\" where \"menu_id\" = $1 and \"role_id\" in (%s)",
...
func removeRolesFromMenusSlice(o *Menu, related []*Role) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
