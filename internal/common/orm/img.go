...
var ImgWhere = struct {
	...
	CategoryID:  whereHelpernull_Int{field: "\"img\".\"category_id\""},
}
...
var (
	imgAllColumns            = []string{"id", "path", "description", "created_at", "updated_at", "deleted_at", "category_id"}
	imgColumnsWithoutDefault = []string{"path", "updated_at"}
