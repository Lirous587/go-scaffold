...
var OrganizationTableColumns = struct {
	...
	PlanType:  "organizations.plan_type",
...
var OrganizationWhere = struct {
	...
	OrgID:     whereHelperstring{field: "\"organizations\".\"org_id\""},
	Name:      whereHelperstring{field: "\"organizations\".\"name\""},
	OwnerID:   whereHelperstring{field: "\"organizations\".\"owner_id\""},
	PlanType:  whereHelpernull_String{field: "\"organizations\".\"plan_type\""},
...
var (
	organizationAllColumns            = []string{"org_id", "name", "owner_id", "plan_type", "created_at", "status"}
	organizationColumnsWithoutDefault = []string{"name", "owner_id"}
	organizationColumnsWithDefault    = []string{"org_id", "plan_type", "created_at", "status"}
	organizationPrimaryKeyColumns     = []string{"org_id"}
...
func (q organizationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Organization, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: failed to execute a one query for organizations")
	}
...
func (q organizationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to count organizations rows")
	}
...
func (q organizationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "orm: failed to check if organizations exists")
	}
...
func FindOrganization(ctx context.Context, exec boil.ContextExecutor, orgID string, selectCols ...string) (*Organization, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"organizations\" where \"org_id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: unable to select from organizations")
	}
...
func (o *Organization) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no organizations provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to insert into organizations")
	}
...
func (o *Organization) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("orm: unable to update organizations, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update organizations row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by update for organizations")
	}
...
func (q organizationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all for organizations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected for organizations")
	}
...
func (o *Organization) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("orm: no organizations provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("orm: unable to upsert organizations, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(organizationPrimaryKeyColumns) == 0 {
				return errors.New("orm: unable to upsert organizations, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert organizations")
	}
...
func (o *Organization) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"organizations\" WHERE \"org_id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete from organizations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by delete for organizations")
	}
...
func (q organizationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from organizations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by deleteall for organizations")
	}
...
func (o *Organization) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindOrganization(ctx, exec, o.OrgID)
	if err != nil {
		return err
	}
...
func OrganizationExists(ctx context.Context, exec boil.ContextExecutor, orgID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"organizations\" where \"org_id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "orm: unable to check if organizations exists")
	}
...
func (o *Organization) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return OrganizationExists(ctx, exec, o.OrgID)
}
